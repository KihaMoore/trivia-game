$(document).ready(function () {
	...
	var questionArray = [{question: "Which event occurs when the user clicks on an HTML element?",
			 answers: [{ text: "onclick", isCorrect: true },{ text: "onmouseover", isCorrect: false },
				{ text: "onchange", isCorrect: false },{ text: "onmouseclick", isCorrect: false }]
		       },
		     
			     {question: "What is the correct syntax for referring to an external script called 'cats.js'?",
			  answers: [{ text: "&lt;script name='cats.js'&gt;", isCorrect: false },
				   { text: "&lt;script src='cats.js'&gt;", isCorrect: true },
				{  text: "&lt;script href='cats.js'&gt;", isCorrect: false },]
		      },
		
			    {question: "JavaScript is the same as Java.?",
			        answers: [{ text: "Yes", isCorrect: false },{ text: "No", isCorrect: true }]
		       },
		
			   {question: "How do you write an IF statement in JavaScript?",
			        answers: [{ text: "if i == 1 then", isCorrect: false },{ text: "if i = 1", isCorrect: false },
				 { text: "if i = 1 then", isCorrect: false },{ text: "if (i == 1)", isCorrect: true }]
		        },
		
			     {question: "Is JavaScript case-sensitive?",
			         answers: [{ text: "Yes", isCorrect: true },{ text: "No", isCorrect: false }]
		        },
		
			      {question: "To see if three variables are all equal, we would use:",
			           answers: [{ text: "A = B = C", isCorrect: false },{ text: "A === B === C", isCorrect: false },
				   { text: "(A == B) && (B == C)", isCorrect: true },{ text: "(A = B) && (B = C)", isCorrect: false }]
		         },
		   
			      {question: "A property is the object-oriented equivalent of:",
			          answers: [{ text: "a function", isCorrect: false },{ text: "a variable", isCorrect: true },
				    { text: "a reserved word", isCorrect: false },{ text: "an object", isCorrect: false }]
		         },
				...
				{ text: "NaN", isCorrect: false }]
			     ...
			     {question: "How does a FOR loop start?",
			         answers: [{ text: "for (i <= 5; i++)", isCorrect: false },{ text: "for (i = 0; i <= 5)", isCorrect: false },
				   { text: "for (i = 0; i <= 5; i++)", isCorrect: true },{ text: "for i = 1 to 5", isCorrect: false }]
		          },
		
			     {question: "How do you generate a random number and round it up to the next integer?",
			        answers: [{ text: "Math.floor(Math.random())", isCorrect: false },{ text: "Math.round(Math.random())", isCorrect: false },
				{ text: "Math.ceiling(Math.random())", isCorrect: false },{ text: "Math.ceil(Math.random())", isCorrect: true }]
		        }];
